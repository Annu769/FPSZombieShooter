...
namespace FPSZombie.zombie
{
    ...
    public class ZombieService : GenericSingleTon<ZombieService>
    {
        private List<ZombieController> zombies;
        private int maxZombieCount = 100;       
        ...
        {           
            ...
            playertransform = PlayerService.instance.GetPlayerTransform().transform;
